  ...
  return (
    <div className="mx-auto flex w-fit flex-wrap justify-center gap-4">
      <PricingCard
        label="Free"
        monthlyPrice="0"
        description="Comece a organizar sua coleção de vinil sem pagar nada. Perfeito pra quem tá começando."
        cta="Começar grátis"
      ...
      <PricingCard
        label="Colecionador"
        monthlyPrice="14,90"
        description="Wishlist ilimitada, alertas de preço e lista de compras mensal. Pra quem leva vinil a sério."
        cta="Trial grátis de 14 dias"
      ...
      <PricingCard
        label="Obsessivo"
        monthlyPrice="29,90"
        description="Tudo ilimitado + integração Discogs + suporte prioritário + acesso antecipado a novidades."
        cta="Assinar agora"
...
const PricingCard = ({ label, monthlyPrice, description, cta, background, BGComponent }: PricingCardProps) => {
  return (
    ...
    >
      ...
      <Link href="/login" className="absolute bottom-4 left-4 right-4 z-20 block rounded-lg border-2 border-white bg-white py-2 text-center font-mono font-black uppercase text-neutral-800 backdrop-blur-sm transition-all duration-200 hover:bg-white/10 hover:text-white hover:border-white/80 focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-transparent">
        {cta}
      </Link>
      <BGComponent />
    </motion.div>
...
const BGComponent1 = () => (
  <motion.svg width="320" height="384" viewBox="0 0 320 384" fill="none" xmlns="http://www.w3.org/2000/svg"
    variants={{ hover: { scale: 1.5 } }} transition={{ duration: 1, ease: "backInOut" }} className="absolute inset-0 z-0">
    <motion.circle variants={{ hover: { scaleY: 0.5, y: -25 } }} transition={{ duration: 1, ease: "backInOut", delay: 0.2 }}
      cx="160.5" cy="114.5" r="101.5" fill="rgba(0, 0, 0, 0.2)" className="dark:fill-white/10" />
    <motion.ellipse variants={{ hover: { scaleY: 2.25, y: -25 } }} transition={{ duration: 1, ease: "backInOut", delay: 0.2 }}
      cx="160.5" cy="265.5" rx="101.5" ry="43.5" fill="rgba(0, 0, 0, 0.2)" className="dark:fill-white/10" />
  </motion.svg>
);

const BGComponent2 = () => (
  <motion.svg width="320" height="384" viewBox="0 0 320 384" fill="none" xmlns="http://www.w3.org/2000/svg"
    variants={{ hover: { scale: 1.05 } }} transition={{ duration: 1, ease: "backInOut" }} className="absolute inset-0 z-0">
    <motion.rect x="14" width="153" height="153" rx="15" fill="rgba(0, 0, 0, 0.2)" className="dark:fill-white/10"
      variants={{ hover: { y: 219, rotate: "90deg", scaleX: 2 } }} style={{ y: 12 }} transition={{ delay: 0.2, duration: 1, ease: "backInOut" }} />
    <motion.rect x="155" width="153" height="153" rx="15" fill="rgba(0, 0, 0, 0.2)" className="dark:fill-white/10"
      variants={{ hover: { y: 12, rotate: "90deg", scaleX: 2 } }} style={{ y: 219 }} transition={{ delay: 0.2, duration: 1, ease: "backInOut" }} />
  </motion.svg>
);

const BGComponent3 = () => (
  <motion.svg width="320" height="384" viewBox="0 0 320 384" fill="none" xmlns="http://www.w3.org/2000/svg"
    variants={{ hover: { scale: 1.25 } }} transition={{ duration: 1, ease: "backInOut" }} className="absolute inset-0 z-0">
    <motion.path variants={{ hover: { y: -50 } }} transition={{ delay: 0.3, duration: 1, ease: "backInOut" }}
      ...
      fill="rgba(0, 0, 0, 0.2)" className="dark:fill-white/10" />
